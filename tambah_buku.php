        ...
        <div class="container main-menu">
          <div class="row row-cols-1 row-cols-md-3 gx-5 d-flex justify-content-between">
            ...
            <div class="col-md-3 side-kiri pt-3 p-2 pb-5">
              ...
              <a href="koleksi_buku.php" class="row link-menu justify-content-around active1">
                ...
                <div class="col-md-12">
                  <form class="form-crud row g-3">
                    ...
                    <div class="col-12">
                      ...
                      <img class="mt-3 mb-5" src="gambar/CoverBuku/Jika Kita Tak pernah Jatuh cinta.jpg" alt="buku" />
                    </div>
